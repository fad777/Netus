...
public class UpdateLinkNode extends ShapeNode //javax.swing.JPanel implements MouseListener,MouseMotionListener,ActionListener{
{
    //JPopupMenu popup;
    ...
    public UpdateLinkNode(InfluenceGUI rootp,Node node)
    {
        super(rootp,node);
...
public UpdateLinkNode(InfluenceGUI rootp,ShapeNode pnode,ShapeNode cnode,Node node)
    {
        super(rootp,node);
...
public void mouseReleased(MouseEvent evt) {
    ...
    public void actionPerformed(ActionEvent ae)
    {
                ...
                UpdateLinkNodeProperty np=new UpdateLinkNodeProperty(this,rootpane, true);
    ...
    protected void paintComponent(Graphics g){
       ...
       //this.setBounds(rootpane.getBounds());
        if(this.parent!=null && this.child!=null){
             ...
             startPt = new Point2D.Double(this.x1,this.y1);
             endPt = new Point2D.Double(this.x2,this.y2);
